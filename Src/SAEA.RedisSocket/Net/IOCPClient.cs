...
{
    public class IOCPClient : BaseClientSocket
    {
        public event Action<string> OnMessage;

        public IOCPClient(int bufferSize = 100 * 1024, string ip = "127.0.0.1", int port = 39654) : base(new RContext(), ip, port, bufferSize)
        {
        }
