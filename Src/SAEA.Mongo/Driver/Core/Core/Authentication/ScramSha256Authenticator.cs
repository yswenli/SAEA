...
using SAEA.Mongo.Driver.Core.Authentication.Vendored;
...
using Rfc2898DeriveBytes = SAEA.Mongo.Driver.Core.Authentication.Vendored.Rfc2898DeriveBytes;

namespace SAEA.Mongo.Driver.Core.Authentication
{
    /// <summary>
