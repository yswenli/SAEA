...
using IClock = SAEA.Mongo.Driver.Support.IClock;
using SystemClock = SAEA.Mongo.Driver.Support.SystemClock;
...
namespace SAEA.Mongo.Driver
{
    ...
    /// </summary>
    /// <seealso cref="SAEA.Mongo.Driver.IClientSessionHandle" />
