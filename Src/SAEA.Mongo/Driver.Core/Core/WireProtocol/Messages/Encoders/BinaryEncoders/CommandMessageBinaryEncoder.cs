...
namespace SAEA.Mongo.Driver.Core.WireProtocol.Messages.Encoders.BinaryEncoders
{
    /// <summary>
    /// Represents a binary encoder for a CommandMessage.
    /// </summary>
    /// <seealso cref="SAEA.Mongo.Driver.Core.WireProtocol.Messages.Encoders.BinaryEncoders.MessageBinaryEncoderBase" />
