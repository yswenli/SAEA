...
[![NuGet version (Newtonsoft.Json)](https://img.shields.io/badge/SAEA.Socket-3.3.1.2-brightgreen.svg)](https://www.nuget.org/packages?q=saea.socket)
...
```
Install-Package SAEA.Sockets -Version 3.3.1.2
```
